...
func (m *RegisterUser) Validate(formats strfmt.Registry) error {
	...
	if err := m.validatePseudo(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RegisterUser) validatePseudo(formats strfmt.Registry) error {

	if err := validate.Required("pseudo", "body", m.Pseudo); err != nil {
		return err
	}
